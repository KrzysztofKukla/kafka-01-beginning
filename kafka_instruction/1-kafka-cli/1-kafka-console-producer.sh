...
kafka-console-producer --bootstrap-server 127.0.0.1:9092 --topic new_topic
hello world!

# our new topic only has 1 partition
kafka-topics --bootstrap-server 127.0.0.1:2181 --list
kafka-topics --bootstrap-server 127.0.0.1:2181 --topic new_topic --describe

# edit config/server.properties
# num.partitions=3

# produce against a non existing topic again
kafka-console-producer --bootstrap-server 127.0.0.1:9092 --topic new_topic_2
hello again!

# this time our topic has 3 partitions
kafka-topics --bootstrap-server 127.0.0.1:2181 --list
kafka-topics --bootstrap-server 127.0.0.1:2181 --topic new_topic_2 --describe
